...
int main()
{
    const Sphere sphere(glm::vec3(1.0f, 2.0f, 3.0f), 1.0f);

    Intersection intersection{};
    const Ray front_ray{glm::vec3(1.0f, 2.0f, 0.0f), glm::vec3(0.0f, 0.0f, 1.0f)};
    assert(sphere.Intersect(front_ray, intersection));
    assert_near(intersection.t, 2.0f);
    assert_vector_near(intersection.position, glm::vec3(1.0f, 2.0f, 2.0f));
    assert_vector_near(intersection.normal, glm::vec3(0.0f, 0.0f, -1.0f));

    const Ray inside_ray{glm::vec3(1.0f, 2.0f, 3.0f), glm::vec3(1.0f, 0.0f, 0.0f)};
    assert(sphere.Intersect(inside_ray, intersection));
    assert_near(intersection.t, 1.0f);
    assert_vector_near(intersection.position, glm::vec3(2.0f, 2.0f, 3.0f));
    assert_vector_near(intersection.normal, glm::vec3(1.0f, 0.0f, 0.0f));

    const Ray miss_ray{glm::vec3(1.0f, 2.0f, 0.0f), glm::vec3(0.0f, 1.0f, 0.0f)};
